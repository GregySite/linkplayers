...
import { Grid3X3, Ship, Users, Zap } from 'lucide-react';
        ...
        <div className="container mx-auto px-4 py-16 relative">
          ...
          >
            <Button
              ...
              variant="outline"
              size="lg"
              className="border-primary/50 hover:bg-primary/10 hover:border-primary text-foreground font-semibold px-8"
            >
          ...
          >
            <h2 className="text-sm uppercase tracking-wider text-muted-foreground mb-4 text-center font-medium">
              Choisir un jeu
            </h2>
            <div className="grid gap-4">
              <GameCard
                type="morpion"
                title="Morpion"
                description="Le classique des classiques. Aligne 3 symboles pour gagner !"
                icon={<Grid3X3 className="w-6 h-6" />}
                onClick={() => handleCreateGame('morpion')}
              />
              <GameCard
                type="battleship"
                title="Bataille Navale"
                description="Place tes navires et coule la flotte adverse !"
